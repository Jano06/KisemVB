...
Partial Class sw_inventarios_entradas
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        If Not IsPostBack Then
            ...
            objEtiqueta.Text = "Entradas de Producto"
    ...
    Sub llenagrid()
        ...
        strTeamQuery += "SELECT productos.id AS idprod, bodegas.id AS idbodegaprov, inventario_entradas.id, bodegas.nombre AS bodega, CONCAT(asociados.nombre, ' ', asociados.appaterno, ' ', apmaterno) AS usuario, inventario_entradas.fecha, productos.nombre AS producto, inventario_entradas.cantidad "
        strTeamQuery += "FROM asociados INNER JOIN (bodegas INNER JOIN (productos INNER JOIN inventario_entradas ON productos.id = inventario_entradas.producto) ON bodegas.id = inventario_entradas.bodega) ON asociados.id = inventario_entradas.usuario "
    ...
    Sub actualizainventarios()
        ...
        'si no hay producto, lo da de alta

        strTeamQuery = "SELECT cantidad FROM inventario WHERE bodega=" & Me.bodegasprov.SelectedItem.Value.ToString & " AND producto=" & Me.productos.SelectedItem.Value.ToString
        ...
        If Not bandera Then
            sqlConn.Open()
            strTeamQuery = "INSERT INTO inventario (producto, bodega, cantidad) VALUES (" & Me.productos.SelectedItem.Value.ToString & ", " & Me.bodegasprov.SelectedItem.Value.ToString & ", 0);"
    ...
    Sub agregasalida()
        ...
        sqlConn.Open()
        strTeamQuery = "INSERT INTO inventario_entradas (`bodega`, `producto`, `cantidad`, `fecha`, `usuario`) VALUES (" & Me.bodegasprov.SelectedItem.Value.ToString & ", " & Me.productos.SelectedItem.Value.ToString & ", " & Me.cantidad.Text & ", '" & CDate(Me.fecha.Text).ToString("yyyy/MM/dd") & "', " & Session("idasociado").ToString & " )"
    ...
    Sub eliminasalida(ByVal salida As Integer)
        ...
        sqlConn.Open()
        strTeamQuery = "DELETE FROM inventario_entradas WHERE id=" & salida.ToString
