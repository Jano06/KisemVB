<%@ Page Language="VB" MasterPageFile="~/sw/MasterMaqueta.master" AutoEventWireup="false" CodeFile="comisiones_nuevas.aspx.vb" Inherits="sw_comisiones_nuevas" title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    Text="Iniciar" ValidationGroup="pago" style="width: 50px" /></span></p>
                                            <p>
                                                ...
                                                <asp:Button ID="Button3" runat="server" Text="No oprimir" Visible="False" />
                                            </p>
