<%@ Page Language="VB" MasterPageFile="~/sw/MasterMaqueta.master" AutoEventWireup="false" CodeFile="inventarios_agregarproductos.aspx.vb" Inherits="sw_inventarios_agregarproductos" title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        <td class="titulobienvenida" colspan="2">
            Alta de Productos en Bodega<asp:Label ID="mensajes" runat="server" CssClass="exito"></asp:Label>
            &nbsp;</td>
        <td class="titulo">
                &nbsp;</td>
    </tr>
    ...
    <tr>
        <td class="textonuevo">
            Bodega:</td>
        <td>
            <asp:DropDownList ID="bodegas" runat="server" Width="350px" 
