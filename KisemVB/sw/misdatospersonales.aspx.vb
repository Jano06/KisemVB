...
Partial Class sw_misdatospersonales
    ...
    Sub llenamisdatos()
        ...
        While dtrTeam.Read
            ...
            If Not IsDBNull(dtrTeam("EstadoCivil")) Then Me.EstadoCivil.Text = dtrTeam("EstadoCivil").ToString
            ...
            If Not IsDBNull(dtrTeam("factura")) Then
                If dtrTeam("factura") = 0 Then
                    Me.factura.Text = "Retención de ISR"
                Else
